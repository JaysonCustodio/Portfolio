...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        'service_m5s6g9o',       // Replace with your actual EmailJS service ID
        'template_mr1w6jb',      // Replace with your actual EmailJS template ID
        {
          from_name: form.name,
          reply_to: form.email,
          message: form.message,
        },
        'O6tQfAqxP4PBvxhU-'        // Replace with your EmailJS public key
      )
