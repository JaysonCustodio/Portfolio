        ...
        <div className={`${isOn ? "group" : ""} flex flex-row max-sm:flex-col h-screen`}>
            ...
            {[
                ...
                >
                    <Link
                        href={href}
                        className={`hover:bg-black hover:z-50 cursor-pointer p-3 rounded-lg relative z-10 text-white text-3xl font-bold 
                                    opacity-0 group-hover:opacity-100 transition-opacity duration-500 
                                    backdrop-blur-md bg-white/10 hover:bg-gradient-to-r hover:${gradient} 
                                    hover:text-black shadow-md transform hover:scale-105`}
                    >
                        {label}
                    </Link>
